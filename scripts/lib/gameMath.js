...
define(function() {
	...
	intersect: function(lineSeg1, lineSeg2) {
	    ...
	    // Note, there can be floating point errors where
	    // equality checking without error bound will cause this to
	    // not pass these two if statements
	    ...
	    if ((lineSeg1.x2 === lineSeg2.x2 && lineSeg1.y2 === lineSeg2.y2) ||(lineSeg1.x2 === lineSeg2.x1 && lineSeg1.y2 === lineSeg2.y1)) {
		// The segments share an endpoint
